...
G4DriftElectron*  G4DriftElectron::Definition() 
{
  if (theInstance !=0) return theInstance;

  const G4String name = "driftelectron";
...
G4DriftElectron*  G4DriftElectron::DriftElectronDefinition() 
{
  return Definition();
}

G4DriftElectron*  G4DriftElectron::DriftElectron() 
{
  return Definition();
}
