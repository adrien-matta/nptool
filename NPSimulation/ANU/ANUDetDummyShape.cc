...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ANUDetDummyShape::AddModule(G4ThreeVector X1_Y1     ,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ANUDetDummyShape::AddModule(G4double R        ,
                                         G4double Theta    ,
                                         G4double Phi      ,
                                         G4double beta_u   ,
                                         G4double beta_v   ,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void ANUDetDummyShape::VolumeMaker(G4int TelescopeNumber,
                                           G4ThreeVector MMpos,
...
//   Copper = new G4Material("Cu", z = 29., a, density);
   ...
   G4Box*           solidANUDummyShape = new G4Box(Name, 0.5*FaceFrontWidth, 0.5*FaceFrontLength, 0.5*Thickness);
   G4LogicalVolume* logicANUDummyShape = new G4LogicalVolume(solidANUDummyShape, Vacuum, Name, 0, 0, 0);
   ...
   //logicANUDummyShape->SetVisAttributes(G4VisAttributes::Invisible);
   logicANUDummyShape->SetVisAttributes(G4VisAttributes(G4Colour(1, 0., 0.0)));  // red
   //if (m_non_sensitive_part_visiualisation) logicANUDummyShape->SetVisAttributes(G4VisAttributes(G4Colour(0.90, 0.90, 0.90)));
...
void ANUDetDummyShape::ReadSensitive(const G4Event* event)
{
   ...
   //Detector Number
   G4int StripDetCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/DetectorNumber")    ;
   DetectorNumberHitMap = (G4THitsMap<G4int>*)(event->GetHCofThisEvent()->GetHC(StripDetCollectionID))         ;
   DetectorNumber_itr =  DetectorNumberHitMap->GetMap()->begin()                                               ;

   //Energy
   G4int StripEnergyCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/StripEnergy")   ;
   EnergyHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripEnergyCollectionID))                    ;
   Energy_itr = EnergyHitMap->GetMap()->begin()                                                          ;

   //Time of Flight
   G4int StripTimeCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/StripTime")    ;
   TimeHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripTimeCollectionID))                        ;
   Time_itr = TimeHitMap->GetMap()->begin()                                                              ;

   //Strip Number X
   G4int StripXCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/StripIDFront")    ;
   XHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripXCollectionID))                              ;
   X_itr = XHitMap->GetMap()->begin()                                                                    ;

   //Strip Number Y
   G4int StripYCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/StripIDBack");
   YHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripYCollectionID))                              ;
   Y_itr = YHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate X
   G4int InterCoordXCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/InterCoordX")    ;
   PosXHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordXCollectionID))                              ;
   Pos_X_itr = PosXHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Y
   G4int InterCoordYCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/InterCoordY")    ;
   PosYHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordYCollectionID))                              ;
   Pos_Y_itr = PosYHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Z
   G4int InterCoordZCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/InterCoordZ")    ;
   PosZHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordZCollectionID))                              ;
   Pos_Z_itr = PosXHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Angle Theta
   G4int InterCoordAngThetaCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/InterCoordAngTheta")    ;
   AngThetaHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordAngThetaCollectionID))                              ;
   Ang_Theta_itr = AngThetaHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Angle Phi
   G4int InterCoordAngPhiCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("FirstStageScorerANUDummyShape/InterCoordAngPhi")    ;
   ...
   for (G4int l = 0; l < sizeN; l++) {
      ...
      if (N > 0) {
         ...
         ms_Event->SetANUFirstStageEDetectorNbr(m_index["DummyShape"] + N);
         ms_Event->SetANUFirstStageTDetectorNbr(m_index["DummyShape"] + N);
         ...
         for (G4int l = 0 ; l < sizeE ; l++) {
            ...
            if (ETrackID == NTrackID) {
               ms_Event->SetANUFirstStageEEnergy(RandGauss::shoot(E, ResoFirstStage));
              }
            Energy_itr++;
         }
         ...
         for (G4int h = 0 ; h < sizeT ; h++) {
            ...
            if (TTrackID == NTrackID) {
               ...
               ms_Event->SetANUFirstStageTTime(RandGauss::shoot(T, ResoTimeGpd));
           }
            Time_itr++;
         }
         ...
         for (G4int h = 0 ; h < sizeX ; h++) {
	      ...
	      ms_Event->SetANUFirstStageEStripNbr(int(X));
	      ms_Event->SetANUFirstStageTStripNbr(int(X));
            }
            X_itr++;
         }
         ...
         for (G4int h = 0 ; h < sizeX ; h++) {
	      ...
	      ms_InterCoord->SetDetectedPositionZ(RandGauss::shoot(PosZ, ResoFirstStage)) ; // for ANU !!!!
            }
            Pos_Z_itr++;
         }
...
void ANUDetDummyShape::InitializeScorers()
{
   ...
   m_FirstStageScorer                                   = new G4MultiFunctionalDetector("FirstStageScorerANUDummyShape");
   ...
   G4VPrimitiveScorer* Energy                           = new ANUScorerFirstStageEnergy("StripEnergy", "ANUDummyShape", 0);
   G4VPrimitiveScorer* StripPositionX                   = new ANUScorerFirstStageFrontStripDummyShape("StripIDFront", 0, NumberOfStrips);
   G4VPrimitiveScorer* StripPositionY                   = new ANUScorerFirstStageBackStripDummyShape("StripIDBack", 0, NumberOfStrips);
