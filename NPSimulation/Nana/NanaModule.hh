...
public:
   ...
   // Read sensitive part of a the NanaModule detector and fill the Root tree.
   ...
   // deriving from NanaModule
   // This is mandatory since the Nana*** does not derive from VDetector
   ...
   // Initialize the Index map for the different modules of Nana
   void InitializeIndex();

public:
   TNanaData*		GetEventPointer() 	{return ms_Event;};

protected:
   // Class to store the result of simulation
   static TNanaData*		ms_Event;
