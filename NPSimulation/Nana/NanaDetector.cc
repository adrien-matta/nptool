 ...
 *---------------------------------------------------------------------------*
 * Decription: Define a detector module for the Nana detector.              *
 *                                                                           *
 *---------------------------------------------------------------------------*
 * Comment:                                                                  *
 *                                                                           *
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void NanaDetector::AddModule(G4ThreeVector X1_Y1,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void NanaDetector::AddModule(G4double R,
                               G4double Theta,
                               G4double Phi,
                               G4double beta_u,
                               G4double beta_v,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void NanaDetector::VolumeMaker(G4int             DetecNumber,
                                 G4ThreeVector     MMpos,
                                 ...
                                 G4LogicalVolume*  world)
{
   ...
   G4String Name = "NanaDetector" + DetectorNumber ;

   // Mother Volume
   //G4Box*           solidNanaDetector = new G4Box(Name, 0.5*FaceFront, 0.5*FaceFront, 0.5*Length);
   G4Tubs*           solidNanaDetector = new G4Tubs(Name,0, 0.5*FaceFront, 0.5*Length, 0.*deg, 360.*deg);
   G4LogicalVolume* logicNanaDetector = new G4LogicalVolume(solidNanaDetector, Vacuum, Name, 0, 0, 0);
   ...
   logicNanaDetector->SetVisAttributes(G4VisAttributes::Invisible);
   //logicNanaDetector->SetVisAttributes(G4VisAttributes(G4Colour(0.90, 0.90, 0.90)));
   //if (m_non_sensitive_part_visiualisation) logicNanaDetector->SetVisAttributes(G4VisAttributes(G4Colour(0.90, 0.90, 0.90)));
...
void NanaDetector::ReadConfiguration(string Path)
{
   ifstream ConfigFile;
   ...
   while (!ConfigFile.eof()) {
      ...
      while (ReadingStatus) {
         ...
         else G4cout << "WARNING: Wrong Token, NanaDetector: Detector Element not added" << G4endl;
...
void NanaDetector::ConstructDetector(G4LogicalVolume* world)
{
...
// of the simulation
void NanaDetector::InitializeRootOutput()
{
}
...
void NanaDetector::SetInterCoordPointer(TInteractionCoordinates* interCoord)
{
...
void NanaDetector::ReadSensitive(const G4Event* event)
{
   //////////////////////////////////////////////////////////////////////////////////////
   ...
   */
   ...
   //Detector Number
   G4int StripDetCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/DetectorNumber")    ;
   DetectorNumberHitMap = (G4THitsMap<G4int>*)(event->GetHCofThisEvent()->GetHC(StripDetCollectionID))         ;
   DetectorNumber_itr =  DetectorNumberHitMap->GetMap()->begin()                                               ;

   //Crystal Number
   G4int CrystDetCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/CrystalNumber")    ;
   ...
   //Energy
   G4int StripEnergyCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/StripEnergy")   ;
   EnergyHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripEnergyCollectionID))                    ;
   Energy_itr = EnergyHitMap->GetMap()->begin()                                                          ;

   //Time of Flight
   G4int StripTimeCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/StripTime")    ;
   TimeHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripTimeCollectionID))                        ;
   Time_itr = TimeHitMap->GetMap()->begin()                                                              ;

   /*
   //Strip Number X
   G4int StripXCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/StripIDFront")    ;
   XHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripXCollectionID))                              ;
   X_itr = XHitMap->GetMap()->begin()                                                                    ;

   //Strip Number Y
   G4int StripYCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/StripIDBack");
   YHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(StripYCollectionID))                              ;
   Y_itr = YHitMap->GetMap()->begin()                                                                    ;
   

   //Interaction Coordinate X
   G4int InterCoordXCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/InterCoordX")    ;
   PosXHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordXCollectionID))                              ;
   Pos_X_itr = PosXHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Y
   G4int InterCoordYCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/InterCoordY")    ;
   PosYHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordYCollectionID))                              ;
   Pos_Y_itr = PosYHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Z
   G4int InterCoordZCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/InterCoordZ")    ;
   PosZHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordZCollectionID))                              ;
   Pos_Z_itr = PosXHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Angle Theta
   G4int InterCoordAngThetaCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/InterCoordAngTheta")    ;
   AngThetaHitMap = (G4THitsMap<G4double>*)(event->GetHCofThisEvent()->GetHC(InterCoordAngThetaCollectionID))                              ;
   Ang_Theta_itr = AngThetaHitMap->GetMap()->begin()                                                                    ;

   //Interaction Coordinate Angle Phi
   G4int InterCoordAngPhiCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("LaBr3StageScorerNanaDetector/InterCoordAngPhi")    ;
   ...
   */
   ...
   //CsI Detector Number
   G4int CsIDetCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("CsIStageScorerNanaDetector/CsIDetectorNumber")    ;
   ...
   G4int CsICryCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("CsIStageScorerNanaDetector/CsICrystalNumber")    ; // added by Marc
   ...
   //CsI Energy
   G4int CsIStageEnergyCollectionID = G4SDManager::GetSDMpointer()->GetCollectionID("CsIStageScorerNanaDetector/CsIStageEnergy")   ;
   ...
   */
   ...
   //DetectorNumberHitMap->PrintAllHits();
    ...
    if (sizeE != sizeT) {
      G4cout << "No match size NANA Event Map: sE:"
      << sizeE << " sT:" << sizeT << endl ;
       ...
       if(sizeN>1)
	 {
		 ...
		 if(Nc==NCryst)  // if we are still in the same crystal than the first hit crystal
		   {
		       ...
		       if(E!=0)
			 {
			   ...
			   ms_Event->SetNANALaBr3StageEDetectorNbr(m_index["Detector"] + N_first);
			   ms_Event->SetNANALaBr3StageTDetectorNbr(m_index["Detector"] + N_first);
			   ms_Event->SetNANALaBr3StageECrystalNbr(NCryst); // added by Marc
			   // Fill Energy
			   // ms_Event->SetNANALaBr3StageEEnergy(RandGauss::shoot(E, ResoFirstStage));
		           E=RandGauss::shoot(E, ResoFirstStage);
		           ms_Event->SetNANALaBr3StageEEnergy(E); // Fill the tree
		           //if(E>EGammaMin && E<EGammaMax)ms_Event->SetNANALaBr3StageEffphpeak(EGamma);

			   // Fill Time
			   ms_Event->SetNANALaBr3StageTTime(RandGauss::shoot(T, ResoTimeGpd));
		   ...
		   if(E!=0)
		     {
		       ...
		       ms_Event->SetNANALaBr3StageEDetectorNbr(m_index["Detector"] + N_first );
		       ms_Event->SetNANALaBr3StageTDetectorNbr(m_index["Detector"] + N_first );
		       ms_Event->SetNANALaBr3StageECrystalNbr(NCryst); // added by Anna
		       // Fill Energy
		       //ms_Event->SetNANALaBr3StageEEnergy(RandGauss::shoot(E, ResoFirstStage));
		       E=RandGauss::shoot(E, ResoFirstStage);
		       ms_Event->SetNANALaBr3StageEEnergy(E); // Fill the tree with energy deposited in first detector
		       //if(E>EGammaMin && E<EGammaMax)ms_Event->SetNANALaBr3StageEffphpeak(EGamma);
	 ...
	 }else
	   {
		 ...
		 //G4cout <<" -4- filling tree with energy=" << E << G4endl;
	       ...
	       ms_Event->SetNANALaBr3StageEDetectorNbr(m_index["Detector"] + N_first);
	       ms_Event->SetNANALaBr3StageTDetectorNbr(m_index["Detector"] + N_first);
	       ms_Event->SetNANALaBr3StageECrystalNbr(NCryst);
		 ...
		 if(NcCsI==NCsICryst)  // if we are still in the same crystal than the first hit CsI crystal
		   {
			 ...
			 {
			   // Fill detector number
			   ms_Event->SetNANACsIStageEDetectorNbr(m_index["Detector"] + NCsI_first);
			   ms_Event->SetNANACsIStageTDetectorNbr(m_index["Detector"] + NCsI_first);
			   ms_Event->SetNANACsIStageECrystalNbr(NCsICryst);
			   // Fill Energy
			   //ms_Event->SetNANACsIStageEEnergy(RandGauss::shoot(E_CsI, ResoSecondStage));
		           E_CsI=RandGauss::shoot(E_CsI, ResoSecondStage);
		           ms_Event->SetNANACsIStageEEnergy(E_CsI); // Fill the tree
		           //if(E_CsI>EGammaMin && E_CsI<EGammaMax)ms_Event->SetNANACsIStageEffphpeak(EGamma);

			   // Fill Time
			   //ms_Event->SetNANACsIStageTTime(RandGauss::shoot(T_CsI, ResoTimeGpd));
			 }
		   ...
		   if(E_CsI!=0)
		     {
		       ...
		       ms_Event->SetNANACsIStageEDetectorNbr(m_index["Detector"] + NCsI_first );
		       ms_Event->SetNANACsIStageTDetectorNbr(m_index["Detector"] + NCsI_first );
		       ms_Event->SetNANACsIStageECrystalNbr(NCsICryst); // added by Marc
		       // Fill Energy
		       //ms_Event->SetNANALaBr3StageEEnergy(RandGauss::shoot(E, ResoFirstStage));
		       E_CsI=RandGauss::shoot(E_CsI, ResoFirstStage);
		       ms_Event->SetNANACsIStageEEnergy(E_CsI); // Fill the tree with energy deposited in first detector
		       //if(E_CsI>EGammaMin && E_CsI<EGammaMax)ms_Event->SetNANACsIStageEffphpeak(EGamma);
...
void NanaDetector::InitializeScorers()
{
   // LaBr3 Associate Scorer
   m_LaBr3StageScorer = new G4MultiFunctionalDetector("LaBr3StageScorerNanaDetector");
  
   //   G4VPrimitiveScorer* DetNbr                           = new GENERALSCORERS::PSDetectorNumber("DetectorNumber", "NanaDetector", 0);
   G4VPrimitiveScorer* DetNbr                           = new NANAScorerLaBr3StageDetectorNumber("DetectorNumber", "NanaDetector", 0);
   //   G4VPrimitiveScorer* TOF                              = new GENERALSCORERS::PSTOF("StripTime","NanaDetector", 0);
   G4VPrimitiveScorer* TOF                              = new NANAScorerLaBr3StageTOF("StripTime","NanaDetector", 0);
   //G4VPrimitiveScorer* InteractionCoordinatesX          = new GENERALSCORERS::PSInteractionCoordinatesX("InterCoordX","NanaDetector", 0);
   //G4VPrimitiveScorer* InteractionCoordinatesY          = new GENERALSCORERS::PSInteractionCoordinatesY("InterCoordY","NanaDetector", 0);
   //G4VPrimitiveScorer* InteractionCoordinatesZ          = new GENERALSCORERS::PSInteractionCoordinatesZ("InterCoordZ","NanaDetector", 0);
   //G4VPrimitiveScorer* InteractionCoordinatesAngleTheta = new GENERALSCORERS::PSInteractionCoordinatesAngleTheta("InterCoordAngTheta","NanaDetector", 0);
   //G4VPrimitiveScorer* InteractionCoordinatesAnglePhi   = new GENERALSCORERS::PSInteractionCoordinatesAnglePhi("InterCoordAngPhi","NanaDetector", 0);

   G4VPrimitiveScorer* Energy                           = new NANAScorerLaBr3StageEnergy("StripEnergy", "NanaDetector", 0);
   G4VPrimitiveScorer* CrystNbr                         = new NANAScorerLaBr3StageCrystal("CrystalNumber", "NanaDetector", 0);

   //   G4VPrimitiveScorer* StripPositionX                   = new NANAcorerLaBr3StageFrontStripDummyShape("StripIDFront", 0, NumberOfStrips);
   //  G4VPrimitiveScorer* StripPositionY                   = new NANAScorerLaBr3StageBackStripDummyShape("StripIDBack", 0, NumberOfStrips);
   ...
   m_CsIStageScorer = new G4MultiFunctionalDetector("CsIStageScorerNanaDetector");
   
   G4VPrimitiveScorer* CsIDetNbr                        = new NANAScorerCsIStageDetectorNumber("CsIDetectorNumber", "NanaDetector", 0);
   G4VPrimitiveScorer* CsICryNbr                        = new NANAScorerCsIStageCrystalNumber("CsICrystalNumber", "NanaDetector", 0); // added by Marc
   G4VPrimitiveScorer* CsIStageEnergy                   = new NANAScorerCsIStageEnergy("CsIStageEnergy", "NanaDetector", 0);
