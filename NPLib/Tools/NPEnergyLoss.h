		 ...
		 public :	//	Constructor
		   ...
		   EnergyLoss(   	string Path 				,	//	Path of dE/dX table file
		   								string Source  			, // Type of file : Geant4,Lise,SRIM
		   				 				...
		   				 				int NumberOfMass  	,
		   				 				int LiseColumns=0		);	//	Indicate which model to read in a lise File, set to 0 (Default value) for a SRIM file);//	Number of mass A of the nucleus (used only for Lise file)	
		   ~EnergyLoss();
