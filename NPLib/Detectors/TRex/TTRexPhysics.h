...
class TTRexPhysics : public TObject, public NPL::VDetector {
  //////////////////////////////////////////////////////////////
  ...
  public:
    ...
    // methods related to the TTRexSpectra class
    // instantiate the TTRexSpectra class and 
  ...
  //////////////////////////////////////////////////////////////
  // specific methods to TRex array
  public:
  ...
  private:
    ...
    TTRexData*         m_PreTreatedData;   //!
    TTRexPhysics*      m_EventPhysics;     //!
  ...
  public:
    ...
    ClassDef(TTRexPhysics,1)  // TRexPhysics structure
};
#endif
