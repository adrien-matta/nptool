#ifndef __QQQPhysics__
#define __QQQPhysics__
/*****************************************************************************
...
class TQQQPhysics : public TObject, public NPL::VDetector{
 ...
 public: //   Specific to QQQ
   ...
   void SetRawDataPointer(TQQQData* rawDataPointer) {EventData = rawDataPointer;}
   // Retrieve raw and pre-treated data
   TQQQData* GetRawData()        const {return EventData;}
   TQQQData* GetPreTreatedData() const {return PreTreatedData;}


 private:   // Data not written in the tree
   int           NumberOfDetector;//!
   TQQQData*    EventData;//!
   TQQQData*    PreTreatedData;//!
   TQQQPhysics* EventPhysics;//!
 ...
 public:  
   ...
   public: // Static constructor to be passed to the Detector Factory
     ...
     ClassDef(TQQQPhysics,1)  // QQQPhysics structure
};


namespace QQQ_LOCAL
{
   double fSi_E( const TQQQData* EventData , const int i );
   double fSi_T( const TQQQData* EventData , const int i );
}
