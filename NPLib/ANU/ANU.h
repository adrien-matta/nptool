...
class ANU : public NPA::VDetector
{
public:
   ANU();
   virtual ~ANU();
...
public:
   ...
   TANUData* 	GetEventData()		{return m_EventData;}
   TANUPhysics*	GetEventPhysics()	{return m_EventPhysics;}
...
private:
   ...
   ////////////////////////////////////////
   TANUData*		m_EventData;
   TANUPhysics*	m_EventPhysics;
