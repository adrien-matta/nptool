...
{
   m_NumberOfModule = 0;
   m_EventData    = new TANUData();
   m_EventPhysics = new TANUPhysics();
}	
...
void ANU::ReadConfiguration(string Path) 	
{
   ...
   while (!ConfigFile.eof()) {
      ...
      //if (LineBuffer.compare(0, 12, "ANUSquare")     == 0  ||
	 ...
	 // if (LineBuffer.compare(0, 13, "ANUAnnular")    == 0) isAnnular    = true;
      ...
      while (ReadingStatus) {	 
         if (isSquare) { 	// square shape
            ...
            else if (DataBuffer.compare(0, 12, "ANUSquare") == 0) {
...
void ANU::ReadCalibrationFile(string Path)	
{
...
void ANU::InitializeRootInput() 		
{
   TChain* inputChain = RootInput::getInstance()->GetChain();
   inputChain->SetBranchStatus("ANU", true);
   inputChain->SetBranchStatus("fANU*", true);
   inputChain->SetBranchAddress("ANU", &m_EventData);
}
...
void ANU::InitializeRootOutput() 	
{
   ...
   outputTree->Branch("ANU", "TANUPhysics", &m_EventPhysics);
}



// This method is called at each event read from the Input Tree. Aime is to build treat Raw dat in order to extract physical parameter. 
void ANU::BuildPhysicalEvent()		
{
...
void ANU::BuildSimplePhysicalEvent()	
{
...
void ANU::AddModuleSquare(TVector3 C_X1_Y1,
                                     TVector3 C_X128_Y1,
                                     TVector3 C_X1_Y128,
...
void ANU::AddModuleSquare(double theta,
                                     double phi,
                                     double distance,
                                     double beta_u,
                                     double beta_v,
...
void ANU::AddModuleDummyShape(TVector3 C_X1_Y1,
                                         TVector3 C_X128_Y1,
                                         TVector3 C_X1_Y128,
                                         TVector3 C_X128_Y128)
{
...
void ANU::AddModuleDummyShape(double theta,
                                         double phi,
                                         double distance,
                                         double beta_u,
                                         double beta_v,
...
TVector3 ANU::GetPositionOfInteraction()
{
