...
void Nana::ReadConfiguration(string Path) 	
{
   ...
   while (!ConfigFile.eof()) {
      ...
      if (LineBuffer.compare(0, 14, "NanaDetector")  == 0  ) {
         cout << "///////////////////////" << endl;
         cout << "Module found:" << endl;        

         if (LineBuffer.compare(0, 14, "NanaDetector") == 0) isDetector = true;
         ReadingStatus = true;
      }
      ...
      // Reading Block
      while (ReadingStatus) {	 
        if (isDetector) { 	// NanaDetector shape
            ...
            else if (DataBuffer.compare(0, 14, "NanaDetector") == 0) {
         ...
         } // end test for NanaDetector shape
...
void Nana::ReadCalibrationFile(string Path)	
{
...
void Nana::BuildSimplePhysicalEvent()	
{
...
//
// Used for 3x3 clusters (NanaCluster):
//
void Nana::AddModuleSquare(TVector3 C_X1_Y1,
                                     TVector3 C_X128_Y1,
                                     TVector3 C_X1_Y128,
                                     TVector3 C_X128_Y128)
{
   ...
   double Face = 169;	 // mm    cf: NanaCluster.hh 
...
void Nana::AddModuleSquare(double theta,
                                     double phi,
                                     double distance,
                                     double beta_u,
                                     double beta_v,
...
//
// Used for single detector (NanaDetector):
//
void Nana::AddModuleDummyShape(TVector3 C_X1_Y1,
                                         TVector3 C_X128_Y1,
                                         TVector3 C_X1_Y128,
                                         TVector3 C_X128_Y128)
{
   ...
   // Geometry Parameter in case of 3x3 cluster
   double Face = 57;	 // mm    cf: NanaCluster.hh 
...
void Nana::AddModuleDummyShape(double theta,
                                         double phi,
                                         double distance,
                                         double beta_u,
                                         double beta_v,
...
double Nana::GetEnergyInDeposit()	// inner Layer	
{ 
...
double Nana::GetEnergyOutDeposit()	// Outer Layer	
{ 
...
TVector3 Nana::GetPositionOfInteraction()
{
